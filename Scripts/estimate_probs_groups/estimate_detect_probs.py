...
def main(argv):
    ...
    kg,l_idx = np.array(np.loadtxt('/Markov_Fish/Scripts/estimate_probs_states/iteration_indices_l_detect.txt')[args.Idx],dtype=int) ##Update path here
    ...
    f = h5py.File(path_to_filtered_data+'/zebrafish_ms_sims/est_probs/detect_probs_group_{}_nbouts_{}_l_{:.2f}.h5'.format(kg,n_bouts,dr),'w')
