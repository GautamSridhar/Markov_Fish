...
def main(argv):
    ...
    ac_samples_state = []
    for ms in range(4):
        f = h5py.File('/flash/StephensU/antonio/zebrafish_ms_sims/est_probs/detect_probs_state_{}_nbouts_{}_l_{:.2f}.h5'.format(ms,n_bouts,dr),'r')
    ...
    delay = 3
    dt = 1
    P_ensemble = csr_matrix(np.load('/bucket/StephensU/antonio/GautamData/P_ensemble_ex8_N1200_s8684.npy'))
    ...
    kms2 = np.load('/bucket/StephensU/antonio/GautamData/cg4_labels.npy')
    ...
    f = h5py.File('/flash/StephensU/antonio/zebrafish_ms_sims/est_probs/bootstrap_detect_probs_states_nbouts_{}_l_{:.2f}.h5'.format(n_bouts,dr),'w')
