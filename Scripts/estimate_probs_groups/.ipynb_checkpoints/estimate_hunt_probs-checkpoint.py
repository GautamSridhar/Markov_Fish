...
def main(argv):
    ...
    kg,l_idx = np.array(np.loadtxt('/home/a/antonio-costa/Zebrafish_ms_sims/estimate_probs_states/iteration_indices_l_hunt.txt')[args.Idx],dtype=int)
    ...
    f = h5py.File('/flash/StephensU/antonio/zebrafish_ms_sims/est_probs/hunt_probs_group_{}_nbouts_{}_l_{:.2f}.h5'.format(kg,n_bouts,dr),'w')
