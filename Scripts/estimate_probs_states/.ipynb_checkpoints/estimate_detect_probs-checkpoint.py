...
def main(argv):
    ...
    ms,l_idx = np.array(np.loadtxt('/home/a/antonio-costa/Zebrafish_ms_sims/estimate_probs_states/iteration_indices_l_detect.txt')[args.Idx],dtype=int)
    ...
    f = h5py.File('/flash/StephensU/antonio/zebrafish_ms_sims/est_probs/detect_probs_state_{}_nbouts_{}_l_{:.2f}.h5'.format(ms,n_bouts,dr),'w')
