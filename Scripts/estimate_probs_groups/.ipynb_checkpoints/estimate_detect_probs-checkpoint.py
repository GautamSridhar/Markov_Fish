...
def main(argv):
    ...
    kg,l_idx = np.array(np.loadtxt('/home/a/antonio-costa/Zebrafish_ms_sims/estimate_probs_states/iteration_indices_l_detect.txt')[args.Idx],dtype=int)
    print('group={},l_idx={}'.format(kg,l_idx),flush=True)
    ...
    for idx in range(100):
        f = h5py.File('/flash/StephensU/antonio/zebrafish_ms_sims/sims_lensim_{}_group_{}_{}.h5'.format(len_sim,kg,idx),'r')
    ...
    f = h5py.File('/flash/StephensU/antonio/zebrafish_ms_sims/est_probs/detect_probs_group_{}_nbouts_{}_l_{:.2f}.h5'.format(kg,n_bouts,dr),'w')
